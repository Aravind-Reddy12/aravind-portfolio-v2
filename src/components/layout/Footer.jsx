  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.25rem' }}>
          {[
            ...
            <a
              ...
              onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--accent-primary)'; e.currentTarget.style.transform = 'rotate(5deg) scale(1.1)'; }}
        ...
        {/* Attribution */}
        <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', fontFamily: '"Satoshi", sans-serif', margin: 0, textAlign: 'center' }}>
          Designed &amp; Built by{' '}
          <span style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>Aravind Reddy</span>
          {' · '}
